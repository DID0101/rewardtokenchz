...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 CHZToken = IBEP20(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48);
    ...
    function deposit() external payable override onlyToken {
        ...
        uint256 balanceBefore = CHZToken.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = router.WETH();
        path[1] = address(CHZToken);
        ...
        uint256 amount = CHZToken.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            CHZToken.transfer(shareholder, amount);
...
contract Mytoken is IBEP20, Auth {
    ...
    address routerAddress = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;
    address CHZToken = 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48; 
